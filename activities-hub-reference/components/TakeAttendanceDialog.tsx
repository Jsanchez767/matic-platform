      ...
      >
        ...
        <div className="bg-gradient-to-r from-violet-600 to-violet-700 text-white px-3 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between mb-3 md:mb-4">
            <div>
              <h2 className="text-lg md:text-2xl">Take Attendance</h2>
              {activity && (
          ...
          <div className="grid grid-cols-3 gap-2 md:gap-3">
            <div className="text-center">
              <div className="text-2xl md:text-4xl mb-0.5 md:mb-1">{presentCount}</div>
              <div className="text-[10px] md:text-xs text-violet-200">Present</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-4xl mb-0.5 md:mb-1">{absentCount}</div>
              <div className="text-[10px] md:text-xs text-violet-200">Absent</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-4xl mb-0.5 md:mb-1">{excusedCount}</div>
        ...
        <div className="bg-white px-3 md:px-6 py-2 md:py-3 border-b border-gray-200">
          <div className="grid grid-cols-2 gap-2 md:gap-3">
            <button
              ...
              className="h-11 md:h-12 rounded-xl border-2 border-emerald-500 bg-emerald-50 text-emerald-700 hover:bg-emerald-100 active:bg-emerald-200 transition-colors flex items-center justify-center gap-1.5 md:gap-2"
            >
            ...
            <button
              ...
              className="h-11 md:h-12 rounded-xl border-2 border-gray-300 bg-white text-gray-700 hover:bg-gray-50 active:bg-gray-100 transition-colors flex items-center justify-center gap-1.5 md:gap-2"
            >
          ...
          <div className="px-3 md:px-6 py-3 md:py-4">
            ...
            {staff.length > 0 && (
              <div className="mb-3 md:mb-4">
                <div className="bg-gray-900 text-white px-3 md:px-4 py-1.5 md:py-2 rounded-t-xl flex items-center gap-2">
                  ...
                  <span className="text-xs md:text-sm">Staff ({staff.length})</span>
                </div>
                <div className="border border-gray-200 rounded-b-xl overflow-hidden">
                  {staff.map((person, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className="text-xs md:text-sm text-gray-900 flex-1 min-w-0 truncate">{person.name}</div>
                        <div className="flex gap-1.5 md:gap-2 flex-shrink-0">
                          <button
                            onClick={() => updateAttendance(person.id, 'present')}
                            className={`h-11 md:h-8 w-11 md:w-auto md:px-3 rounded-lg transition-all flex items-center justify-center gap-0 md:gap-1.5 text-xs ${
            ...
            <div>
              <div className="bg-violet-600 text-white px-3 md:px-4 py-1.5 md:py-2 rounded-t-xl flex items-center gap-2">
                <Users className="h-3.5 md:h-4 w-3.5 md:w-4" />
                <span className="text-xs md:text-sm">Participants ({participants.length})</span>
              </div>
              <div className="border border-gray-200 rounded-b-xl overflow-hidden">
